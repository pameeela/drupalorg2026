...
namespace Drupal\drupalorg_theme\Hook;
...
use Drupal\drupalorg_theme\RenderCallbacks;
...
final class ThemeHooks {
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    $variables['drupalorg_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeList->getPath('drupalorg_theme');
  }
